...
const LEVELS = [
    ...
    // ---- Level 50: Final Judgment ----
    {
        ...
        terrain: [
            ...
            { type: "rock", cells: [{x:12,y:6},{x:9,y:1},{x:11,y:0},{x:10,y:5},{x:2,y:5},{x:13,y:7}] },
            { type: "mountain", cells: [{x:9,y:9},{x:14,y:10},{x:4,y:7}] },
            { type: "river", cells: [{x:0,y:0},{x:1,y:0},{x:2,y:0},{x:3,y:0},{x:4,y:0},{x:5,y:0},{x:6,y:0},{x:7,y:0},{x:8,y:0},{x:9,y:0},{x:10,y:0},{x:12,y:0},{x:13,y:0},{x:14,y:0},{x:15,y:0},{x:16,y:0},{x:17,y:0},{x:18,y:0},{x:19,y:0}] }
        ],
        bg: "#1a0a0a"
    },
];
